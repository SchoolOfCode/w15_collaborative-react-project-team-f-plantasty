            ...
            <div className={styles.mrcSubContainer}>
                ...
                <div className={styles.leftColumn}>
                    <div className={styles.iconBackground}>
                        <img className={styles.Icon} src="https://image.shutterstock.com/image-vector/continuous-one-line-drawing-burger-600w-1005965494.jpg"/>
                    </div>
                    <div className={styles.iconBackground}>
                        <img className={styles.Icon} src="https://image.shutterstock.com/image-vector/continuous-one-line-drawing-burger-600w-1005965494.jpg"/>
                    </div>
                ...
                <div className={styles.middleColumn}>
                    <img className={styles.recipeImage} src="https://static01.nyt.com/images/2021/01/26/well/well-foods-microbiome/well-foods-microbiome-jumbo.jpg?quality=90"/>
                </div>
